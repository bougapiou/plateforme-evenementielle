      ...
      <header class="border-b border-slate-200 bg-white">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <a routerLink="/" class="flex items-center gap-2 font-extrabold text-brand-700">
            <span class="grid h-9 w-9 place-items-center rounded-lg bg-brand-600 text-white">PN</span>
            <span class="hidden sm:block">Plateforme Nationale des Événements</span>
          </a>
