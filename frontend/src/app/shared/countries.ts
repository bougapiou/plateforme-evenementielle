...
export const COUNTRY_CALLING_CODES: CountryCallingCode[] = [
  ...
  { code: 'KP', name: 'Democratic People\'s Republic of Korea', phoneCode: '+850' },
  ...
  { code: 'GB', name: 'United Kingdom of Great Britain and Northern Ireland', phoneCode: '+44' },
  ...
  { code: 'PN', name: 'Pitcairn', phoneCode: '+870' },
